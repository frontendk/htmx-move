def block():
    ...
    <div id="draggable" class="ui-widget-content">
        ...
        <button type="button" hx-delete="/delete/block" hx-target="#draggable" hx-swap="outerHTML">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 34.499 34.499" style="enable-background:new 0 0 34.499 34.499;" 
                xml:space="preserve">
